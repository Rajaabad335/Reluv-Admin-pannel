      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden max-w-4xl">
        <form onSubmit={handleSubmit} className="divide-y divide-gray-100">
          ...
          <div className="flex flex-col md:flex-row md:items-center p-4 md:p-6 gap-2 md:gap-0">
            ...
            <div className="md:w-2/3 relative">
              <select 
                ...
                className="w-full appearance-none bg-white border border-[#cb6f4d] rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#cb6f4d] cursor-pointer text-gray-800"
              >
          ...
          <div className="flex flex-col md:flex-row md:items-center p-4 md:p-6 gap-2 md:gap-0">
            ...
            <div className="md:w-2/3">
              <input 
                ...
                className="w-full bg-white border border-[#cb6f4d] rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#cb6f4d] text-gray-800"
              />
            </div>
          </div>
          ...
          <div className="p-4 md:p-6 flex justify-center bg-[#fcfdfe]">
            <button 
              type="submit"
              className="w-full md:w-auto bg-[#cb6f4d] cursor-pointer text-white font-bold px-10 py-3 md:py-2.5 rounded-lg transition-colors shadow-sm"
            >
              Save Changes
            </button>
          </div>
